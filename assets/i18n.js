(() => {
  ...
  <span class="note">"routing_rules"</span>: <span class="str">"No enviar sin responsable, fuente ni derecho"</span>
    ...
    <span class="note">"routing_rules"</span>: <span class="str">"无负责人、来源或权限不得发送"</span>
            ...
            "footer.info": "<strong>Hyle Labs SASU</strong><br>1 C rue Gérard Neyrin, 69630 Chaponost · contact@hyle-labs.net<br>© <span id=\"year\">2026</span> Hyle Labs. Taveni 由 Hyle Labs 发行。",
            "footer.contact": "联系我们",
            "footer.legal": "法律声明",
            "legal.title": "法律声明",
